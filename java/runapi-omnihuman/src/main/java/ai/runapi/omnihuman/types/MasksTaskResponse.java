...
/** Task response base containing generated mask results. */
public class MasksTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the generated mask results, when present. */
  public List<Mask> getMasks() {
    return masks == null ? null : Collections.unmodifiableList(masks);
  }
  ...
  public void ensureResultPresent() {
    if (masks == null) {
      throw new ValidationException("completed task response is missing masks");
    }
  }
