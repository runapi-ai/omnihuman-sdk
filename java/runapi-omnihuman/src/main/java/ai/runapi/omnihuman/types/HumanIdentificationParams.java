...
/** Parameters for human identification operations. */
public final class HumanIdentificationParams {
  private final String model;
  private final String sourceImageUrl;
  private final String callbackUrl;

  private HumanIdentificationParams(Builder builder) {
    this.model = builder.model;
    this.sourceImageUrl = OmnihumanParamUtils.requireNonBlank(builder.sourceImageUrl, "sourceImageUrl");
    this.callbackUrl = builder.callbackUrl;
  }

  /** Creates a new HumanIdentificationParams builder. */
  ...
  public String action() {
    return "omnihuman/human-identification";
  }
  ...
  /** Builder for {@link HumanIdentificationParams}. */
  public static final class Builder {
    ...
    public Builder model(HumanIdentificationModel value) {
    ...
    /** Builds immutable human identification parameters. */
    public HumanIdentificationParams build() {
      return new HumanIdentificationParams(this);
    }
  }
}
