...
import ai.runapi.omnihuman.types.CompletedAudioToVideoResponse;
    ...
    class OmnihumanLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/omnihuman/audio_to_video", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (OmnihumanClient client =
            OmnihumanClient.builder()
                .apiKey("sk-test")
      ...
      CompletedAudioToVideoResponse response =
        ...
        assertEquals("/api/v1/omnihuman/audio_to_video", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/omnihuman/audio_to_video/task_local_123", captured.path);
